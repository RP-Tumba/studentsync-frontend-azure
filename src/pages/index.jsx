            ...
            <div className="cards">
              <div className="card">
                <div className="card-header">
                  <div className="icon icon-danger danger-danger">< VolunteerActivismIcon /></div>
                  <h3>Race Towards Goodness</h3>
                </div>
                <div className="card-main">
                  <p>Digital transformation empowers students with tools and skills that extend beyond technical proficiency,
                    fostering a learning environment where ethical digital
                    citizenship and proper online conduct become the bedrock of their  future success in an increasingly connected world.</p>
                </div>
              </div>
              <div className="card pink">
                <div className="card-header">
                  <div className="icon icon-white cl-white">< AccessAlarmIcon /></div>
                  <h3>Disciplined and Productive</h3>
                </div>
                <div className="card-main">
                  <p>Discipline in time, as well as discipline in all matters and possessions.
                    Organized and able to manage their agenda/activities so that all their time can be valuable and beneficial.</p>
                </div>
              </div>
              <div className="card">
                <div className="card-header">
                  <div className="icon icon-brown cl-brown">< DirectionsRunIcon /></div>
                  <h3>Disciplined and Productive</h3>
                </div>
                <div className="card-main">
                  <p>Competing and striving in goodness. Having speed and accuracy in doing good deeds.
                    Trained to act swiftly in matters, completing tasks quickly and efficiently.</p>
                </div>
              </div>
            </div>
          </div>
